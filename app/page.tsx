    ...
    <>
      ...
      <main className="overflow-hidden">
        <section className="relative border-b border-black/5 bg-[radial-gradient(circle_at_15%_15%,rgba(31,157,85,0.18),transparent_28%),linear-gradient(135deg,#ffffff_0%,#f1faf3_55%,#ffffff_100%)]">
          ...
          <div className="container-page relative grid min-h-[720px] items-center gap-10 py-14 lg:grid-cols-[1.02fr_0.98fr] lg:py-18">
          ...
          <div className="container-page">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-3">
              {[
                ...
                <article className="rounded-2xl border border-black/8 bg-[#fbfdfb] p-6 shadow-sm" key={item.title}>
        ...
        <section className="container-page py-14">
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {benefits.map((item) => (
                <article className="rounded-2xl border border-black/8 bg-white p-5 shadow-sm" key={item.title}>
        ...
        <section className="bg-ink py-12 text-white">
          <div className="container-page grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-6" key={stat.label}>
...
function SectionHeading({ eyebrow, title, text }: { eyebrow: string; title: string; text?: string }) {
  return (
    <div className="max-w-2xl">
      ...
      {text ? <p className="mt-3 text-base leading-7 text-ink/62">{text}</p> : null}
    </div>
  );
}
